...
import { getRecords, createRecord, deleteRecord, type MedicalRecord } from "./api";
import { getLocalRecords, addLocalRecord, deleteLocalRecord } from "./local";
import type { RecordInput } from "./schema";
import { withTimeout } from "@/lib/query/util";

export const recordKeys = { all: ["records"] as const };
